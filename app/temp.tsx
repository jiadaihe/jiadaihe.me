...
export default function Home() {
  ...
  const project = {
    ...
    description: "A full-stack task management application built with modern web technologies. Features real-time collaboration, drag-and-drop interface, and team management capabilities.",
  ...
  const socialLinks = [
    { name: 'Guestbook', url: 'https://example.com/guestbook' },
    { name: 'Are.na', url: 'https://are.na/username' },
    { name: 'Instagram', url: 'https://instagram.com/username' },
    { name: 'Twitter', url: 'https://twitter.com/username' },
    { name: 'Email', url: 'mailto:your.email@example.com' },
    { name: 'LinkedIn', url: 'https://linkedin.com/in/username' },
    { name: 'GitHub', url: 'https://github.com/username' },
    { name: 'Observable', url: 'https://observablehq.com/@username' },
    { name: 'Blog', url: '/blog' }
  ];
  ...
  return (
    <div className="min-h-screen bg-white flex">
      ...
      <img 
        src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=90&h=90&fit=crop&crop=face"
        alt="Profile"
            ...
            <table className="w-full text-sm mb-6">
              <tbody>
                ...
                <tr>
                  ...
                  <td className="text-right">EN-US</td>
                </tr>
                <tr>
      ...
      <main className="flex-1 p-8">
        ...
        <div className="mb-8">
          <div className="bg-black text-white py-2 mb-2 overflow-hidden">
          ...
          <div className="bg-gray-700 text-white py-2 mb-8 overflow-hidden">
            <div className="animate-pulse text-center text-sm">
              ⚛ Available for hire • Let's build something amazing ☾
            </div>
          </div>
        </div>
        ...
        {/* Abandoned Projects (like Maxwell's) */}
        <section>
          <h2 className="text-3xl font-bold mb-8 flex items-center gap-2">
